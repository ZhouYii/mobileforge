...
namespace MobileForge.Tests.Presentation
{
    ...
    public class UIRouterTests
    {
        ...
        public void SetUp()
        {
            ...
            _router.RegisterScreen("home", () => new object());
            _router.RegisterScreen("shop", () => new object());
            _router.RegisterScreen("inventory", () => new object());
            _router.RegisterScreen("settings", () => new object());
        }
        ...
        {
            Assert.IsTrue(_router.HasScreen("home"), "home screen should be registered");
            Assert.IsTrue(_router.HasScreen("shop"), "shop screen should be registered");
            Assert.IsFalse(_router.HasScreen("nonexistent"), "nonexistent screen should not be registered");
        }
