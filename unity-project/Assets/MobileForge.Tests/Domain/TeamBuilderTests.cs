...
namespace MobileForge.Tests.Domain
{
    ...
    public class TeamBuilderTests
    {
        ...
        public void Set_Slot()
        {
            ...
            Assert.AreEqual(1, ((MonsterInstance)team.GetSlot(0)).DefId, "Slot 0 def_id should match");
        }
        ...
        // AllSameElement is a private method on TeamSkillChecker, not TeamBuilder
        // Removed: Team_Skill_Checker_All_Same_Element test
    }
}
